                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8">
                        <div class="courses__details-thumb">
                            <img src="assets/img/banner/trainingCard.png" alt="img">
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p>Embark on a comprehensive learning journey covering all aspects of web development. Our subscription program provides structured learning every day for 45 days, ensuring you gain deep expertise in this domain.</p>
