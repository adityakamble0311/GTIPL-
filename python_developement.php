                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="courses__details-content">
                            ...
                            <h2 class="title">Python Developement</h2>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="instructors-tab" data-bs-toggle="tab" data-bs-target="#instructors-tab-pane" type="button" role="tab" aria-controls="instructors-tab-pane" aria-selected="false">Benifits</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel" aria-labelledby="overview-tab" tabindex="0">
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p>Python is a versatile, high-level programming language known for its readability and simplicity. It is widely used in web development, data science, artificial intelligence, and more.

Key features include easy syntax, extensive libraries, cross-platform compatibility, and strong community support.</p>
                                        <h3 class="title">What you'll get from this course?</h3>
                                        <ul class="about__info-list list-wrap">
                                        <li class="about__info-list-item">
    <i class="flaticon-angle-right"></i>
    <p class="content">Easy to learn and use</p>
</li>
<li class="about__info-list-item">
    <i class="flaticon-angle-right"></i>
    <p class="content">Powerful libraries (e.g., NumPy, Pandas)</p>
</li>
<li class="about__info-list-item">
    <i class="flaticon-angle-right"></i>
    <p class="content">Scalability and versatility</p>
</li>
<li class="about__info-list-item">
    <i class="flaticon-angle-right"></i>
    <p class="content">Ideal for scripting and automation</p>
</li>
<li class="about__info-list-item">
    <i class="flaticon-angle-right"></i>
    <p class="content">Growing popularity in AI and machine learning</p>
</li>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <ul class="list-wrap">
                        <li class="course-item">
                            <span class="item-name">Backend Development with PHP & Django</span>
                           
                        </li>
                        <li class="course-item">
                            <span class="item-name">Full Stack Development with MEAN/MERN</span>
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <ul class="list-wrap">
                        ...
                        <li class="course-item">
                            <span class="item-name">Advanced Database Management</span>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <ul class="list-wrap">
                        <li class="course-item">
                            <span class="item-name">Additional Web Development Topics</span>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="courses__details-sidebar">
                            ...
                            <div class="courses__cost-wrap">
                                ...
                                <h2 class="title">₹3999 <del>₹15999</del></h2>
                            </div>
