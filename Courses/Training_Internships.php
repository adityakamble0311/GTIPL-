                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8">
                        <div class="courses__details-thumb">
                            <img src="../assets/img/courses/intrainingCard.png" alt="img">
                        </div>
                        <div class="courses__details-content">
                            <ul class="courses__item-meta list-wrap">
                                <li class="courses__item-tag">
                                    <a href="../courses.php">Development</a>
                                </li>
                                <li class="avg-rating"><i class="fas fa-star"></i> (4.8 Reviews)</li>
                            </ul>
                            <h2 class="title">Training & Internships</h2>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="instructors-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="instructors-tab-pane" aria-selected="false">Benifits</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview-tab-pane" role="tabpanel"
                                    ...
                                    <div class="courses__overview-wrap">
                                        ...
                                        <p>Embark on a comprehensive learning journey covering all aspects of web
                                            development. Our subscription program provides structured learning every day
                                            for 45 days, ensuring you gain deep expertise in this domain.</p>
                                        <h3 class="title">What you'll get from this course?</h3>
                                        <ul class="about__info-list list-wrap">
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Total of 45 lectures conducted</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Expert instructors in web development</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Hands-on projects and assignments</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Interactive learning environment</p>
                                            </li>
                                            <li class="about__info-list-item">
                                                <i class="flaticon-angle-right"></i>
                                                <p class="content">Certification upon completion</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap">
                                                            <li class="course-item open-item">
                                                                <span class="item-name">Introduction to Web
                                                                    Development</span>

                                                            </li>
                                                            <li class="course-item">
                                                                <span class="item-name">Advanced Web Development</span>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap">
                                                            <li class="course-item">
                                                                <span class="item-name">Backend Development with PHP &
                                                                    Django</span>

                                                            </li>
                                                            <li class="course-item">
                                                                <span class="item-name">Full Stack Development with
                                                                    MEAN/MERN</span>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseThree" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap">
                                                            <li class="course-item">
                                                                <span class="item-name">Database Fundamentals</span>

                                                            </li>
                                                            <li class="course-item">
                                                                <span class="item-name">Advanced Database
                                                                    Management</span>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseFour" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap">
                                                            <li class="course-item">
                                                                <span class="item-name">Domain Management</span>

                                                            </li>
                                                            <li class="course-item">
                                                                <span class="item-name">Hosting Management</span>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapseFive" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <ul class="list-wrap">
                                                            <li class="course-item">
                                                                <span class="item-name">Additional Web Development
                                                                    Topics</span>
                                    ...
                                    <div class="courses__rating-wrap">
                                        ...
                                        <div class="course-review-head">
                                            ...
                                            <div class="review-author-content">
                                                ...
                                                <p>Maximus ligula eleifend id nisl quis interdum. Sed malesuada tortor
                                                    non turpis semper bibendum nisi porta, malesuada risus nonerviverra
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="courses__details-sidebar">
                            ...
                            <div class="courses__cost-wrap">
                                ...
                                <h2 class="title">₹2999 <del>₹15999</del></h2>
                            </div>
